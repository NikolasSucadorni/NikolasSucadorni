...
Sou **Data Scientist** e **AI Developer**, apaixonado por resolver problemas complexos com inteligência artificial, automações inteligentes e arquiteturas de machine learning escaláveis.

---

## 🚀 Sobre Mim

- 🤖 Atualmente: **AI Developer na emplo.ia** — desenvolvendo, treinando e otimizando modelos de IA em larga escala
...
- **Backend & Automações:** Python, APIs REST, pipelines de produção
- **Deep Learning:** TensorFlow, PyTorch, Scikit-learn
- **Visualização:** Power BI, Matplotlib, Seaborn, Plotly
- **Áreas:** Redes Neurais, Regressão, Classificação, Otimização de Modelos
...
- **Computação Quântica** — algoritmos quânticos, circuitos e aplicações em IA
  ...
  <tr>
    <td>
      <a href="https://github.com/NikolasSucadorni">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=NikolasSucadorni&layout=compact&theme=radical" />
      </a>
    </td>
    <td>
      <a href="https://github.com/NikolasSucadorni">
